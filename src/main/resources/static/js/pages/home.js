...
function setupFeatureCardAnimations() {
    ...
    featureCards.on('click', function() {
        ...
        WebSpace.Core.trackEvent('feature_card_interaction', {
            feature: featureName,
            location: 'home_page'
        });
    });
...
function setupCalculatorGrid() {
    ...
    calculatorCards.each(function() {
        ...
        card.on('click', function(e) {
            ...
            setTimeout(() => {
                ...
                WebSpace.Core.trackEvent('calculator_access', {
    ...
    // Infinite scroll or load more functionality (if needed)
    if ($('.load-more-calculators').length) {
...
function setupCTAButtons() {
    ...
    ctaButtons.each(function() {
        ...
        btn.on('click', function() {
            WebSpace.Core.trackEvent('cta_click', {
...
function setupHeroAnimations() {
    ...
    if (!window.matchMedia('(prefers-reduced-motion: reduce)').matches) {
        $(window).on('scroll', WebSpace.Core.utils.throttle(() => {
...
/**
 * Load more calculators (for infinite scroll)
 */
function loadMoreCalculators() {
    ...
    setTimeout(() => {
        ...
        WebSpace.Core.trackEvent('load_more_calculators', {
